...
import (
	...
	"github.com/PatrickChagastavares/church_backend/test"
...
func TestPing(t *testing.T) {
	cases := map[string]struct {
		...
		"deve retornar erro com a mensagem: ocorreu um erro": {ExpectedErr: model.NewError(http.StatusInternalServerError, "ocorreu um erro", nil), PrepareMock: func(mock sqlmock.Sqlmock) {
